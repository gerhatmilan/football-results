        ...
        for season in available_seasons:
            try:
                data = get_data(client=client, mode=MODE, save=True, config=TOPSCORERS_CONFIG_FILE, filename_parameters=(league_id, season), endpoint_parameters=(league_id, season))
                 ...
                 logging.log(ERROR_LOG_PATH, f'Top scorers data for season {season} is not available yet. Skipping this update')
                 continue
...
logging.log(SUCCESS_LOG_PATH, 'Update of table top_scorers has completed successfully for available seasons\n')