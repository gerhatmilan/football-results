...
namespace FootballResults.DataAccess.Migrations
{
    ...
    [Migration("20241112230010_DefaultAdminUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FootballResults.DataAccess.Entities.SystemInformation", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime?>("CountryFlagsLastDownload")
                        .HasColumnType("timestamp")
                        .HasColumnName("country_flags_last_download");

                    b.Property<DateTime?>("LeagueLogosLastDownload")
                        .HasColumnType("timestamp")
                        .HasColumnName("league_logos_last_download");

                    b.Property<DateTime?>("MatchesLastUpdateForCurrentDay")
                        .HasColumnType("timestamp")
                        .HasColumnName("matches_last_update_for_current_day");

                    b.Property<DateTime?>("PlayerPhotosLastDownload")
                        .HasColumnType("timestamp")
                        .HasColumnName("player_photos_last_download");

                    b.Property<DateTime?>("TeamLogosLastDownload")
                        .HasColumnType("timestamp")
                        .HasColumnName("team_logos_last_download");

                    b.Property<DateTime?>("TopScorerPhotosLastDownload")
                        .HasColumnType("timestamp")
                        .HasColumnName("topscorer_photos_last_download");

                    b.HasKey("ID");

                    b.ToTable("system_information", "public");
            ...
            modelBuilder.Entity("FootballResults.DataAccess.Entities.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegistrataionDate = new DateTime(2024, 11, 12, 23, 0, 10, 135, DateTimeKind.Unspecified).AddTicks(2324),
                            Username = "admin"
                        });
                });
